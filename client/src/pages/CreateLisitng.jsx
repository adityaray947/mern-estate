    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <input type='text' placeholder='Address' className='border p-3 rounded-lg' id="address" maxLength='10' required/>
                <div className='flex gap-6 flex-wrap'>
                    ...
                    <div className='flex gap-2'>
                        <input type="checkbox" id='Parkinglot'  className='w-5'/>
                ...
                <div className='flex items-center gap-2'>
                    <input type="number" id='bathrooms' min='1' max='5' required className='p-3 border-gray-300 rounded-lg' />
                    <p>Baths</p>
                </div>
                <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                <p className='fonr-semibold'>Images:
